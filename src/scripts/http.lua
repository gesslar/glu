...
local HttpResponseClass = Glu.registerClass({
  class_name = "HttpResponseClass",
  script_name = script_name,
  dependencies = deps,
})

function HttpResponseClass.setup(___, self, request)
  self.id = request.id
  -- other stuff
end

local HttpRequestClass = Glu.registerClass({
  class_name = "HttpRequestClass",
  script_name = script_name,
  dependencies = deps,
})

function HttpRequestClass.setup(___, self, options)
  -- Headers
...
function mod.setup(___, self)
  ...
  function self.request(options)
    ...
    local request = HttpRequestClass(options, self)
